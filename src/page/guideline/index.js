    ...
    return (
      <div>
        <div className="container">
          <br/>
          <div className="row">
            <div className="col-xs-8 panel panel-default">
              <div className="panel-body">
                <h1>Using Voice Grader</h1>

                <h3>Introduction</h3>
                <p>Intonation Coach is intended to help you, as a language learner, become more aware of your intonation and model it after patterns used by native speakers. To get started, choose your target language, read the overview and listen to each sample sentence in the overview tab.</p>

                <h3>Recording & Analyzing</h3>
                <p>After youve recorded, you can use the Play Back button to hear your recording, or you can go straight to the Save & Compare button to submit your attempt. Intonation Coach will then analyze your recording and add its pitch contour to the graph, where you can see how it compares to the target intonation.</p>

                <p>You can continue to record and submit attempts as many times as you want; all pitch contours will be displayed simultaneously, and each recording will be catalogued on the right side of the page with a Play button and a Delete button. You can hide a recording from the graph by clicking on its name in the legend at the top right corner of the graph; if you want to discard a recording completely, press the Delete button for it on the right side of the page, and it will be erased and removed from the graph.</p>
